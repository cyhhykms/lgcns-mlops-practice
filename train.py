...
if __name__ == "__main__":
    ...
    logger.info("Running a preprocessing pipeline...가")

    # TODO: X=_X, y=y로 전처리 파이프라인을 적용해 X에 저장
    X = preprocess_pipeline.fit_transform(X=_X, y=y)

    logger.info("Saving a feature data into the storage...선호")
    ...
    logger.info("Setting an experiment...하는 점심")
